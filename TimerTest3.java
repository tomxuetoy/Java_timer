// the original code is from this link: http://java.chinaitlab.com/advance/525535.html
		...
		while (true) {
			try {
				...
				if (strInfo.startsWith("Cancel-1")) {
					...
					// myTask2的状态,所以,这里不能做出是否退出循环的判断. not understood for me, added by Tom Xue
					myTask2.cancel();	// added by Tom Xue
